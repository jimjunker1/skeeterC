...
```{r rankings table}
date_vars = pred_plotDf$date %>% unique %>% as.character %>% .[-1]
...
pred_plotDf %>% 
  ...
  pivot_wider(id_cols = c(name, MAE), names_from = 'date', values_from = 'diff') %>%
  select(name, !!!date_vars, MAE) %>% 
  arrange(MAE, .by_group = FALSE) %>% 
   knitr::kable(digits = 2, caption = "The rankings to date are:") 
# split_kable(., index = 1, n_tb=1, caption = "The rankings to date are:", digits = 2 )
...
lastVal = min(count_df %>% select(count) %>% unlist %>% is.na %>% `!` %>% which %>% max,16)
...
globAvg_accDf %>% 
  ggplot()+
  geom_line(data = globAvg_accDf %>% mutate(count = coalesce(count, prediction)), aes(x = date, y = count), linewidth = 1, color = 'grey')+
  geom_errorbar(data = globAvg_accDf  , aes(x = date, ymin = lower, ymax = upper), linewidth = 1.2, color = 'grey', width = 0)+
  geom_point(data = globAvg_accDf, aes(x = date, y = prediction), size = 2, color = 'grey')+
  geom_line(aes(x = date, y = count), linewidth = 1.1, color = 'black')+
  geom_point(aes(x = date, y = count), size = 1.2, color = 'black')+
  scale_y_continuous(name = "Skeeter Rafts (#)", limits = ylims)+
  scale_x_continuous(breaks = labelsDf$date, labels = labelsDf$datelab, sec.axis = dup_axis(labels = labelsDf$day))+
...
poisSimple_accDf %>% 
  ggplot()+
  geom_line(data = poisSimple_accDf %>% mutate(count = coalesce(count, prediction)), aes(x = date, y = count), linewidth = 1, color = 'grey')+
  geom_errorbar(data = poisSimple_accDf , aes(x = date, ymin = lower, ymax = upper), linewidth = 1.2, color = 'grey', width = 0)+
  geom_point(data = poisSimple_accDf, aes(x = date, y = prediction), size = 2, color = 'grey')+
  geom_line(aes(x = date, y = count), linewidth = 1.1, color = 'black')+
  geom_point(aes(x = date, y = count), size = 1.2, color = 'black')+
  scale_y_continuous(name = "Skeeter Rafts (#)", limits = ylims)+
  scale_x_continuous(breaks = labelsDf$date, labels = labelsDf$datelab, sec.axis = dup_axis(labels = labelsDf$day))+
...
nbSimple_accDf %>% 
  ggplot()+
  geom_line(data = nbSimple_accDf %>% mutate(count = coalesce(count, prediction)), aes(x = date, y = count), linewidth = 1, color = 'grey')+
  geom_errorbar(data = nbSimple_accDf , aes(x = date, ymin = lower, ymax = upper), linewidth = 1.2, color = 'grey', width = 0)+
  geom_point(data = nbSimple_accDf, aes(x = date, y = prediction), size = 2, color = 'grey')+
  geom_line(aes(x = date, y = count), linewidth = 1.1, color = 'black')+
  geom_point(aes(x = date, y = count), size = 1.2, color = 'black')+
  scale_y_continuous(name = "Skeeter Rafts (#)", limits = ylims)+
  scale_x_continuous(breaks = labelsDf$date, labels = labelsDf$datelab, sec.axis = dup_axis(labels = labelsDf$day))+
...
poisGLMMMedian = pois_glmm_pred %>% filter(date == min(as.Date(current_date)+1,as.Date("2024-07-13"))) %>% select(prediction) %>% unlist
# 
poisGLMMInt = pois_glmm_pred %>% filter(date == min(as.Date(current_date)+1,as.Date("2024-07-13"))) %>% select(lower,upper) %>% unlist
...
poisGLMM_accDf %>%
  ggplot()+
  geom_line(data = poisGLMM_accDf %>% mutate(count = coalesce(count, prediction)), aes(x = date, y = count), linewidth = 1, color = 'grey')+
  geom_errorbar(data = poisGLMM_accDf , aes(x = date, ymin = lower, ymax = upper), linewidth = 1.2, color = 'grey', width = 0)+
  geom_point(data = poisGLMM_accDf, aes(x = date, y = prediction), size = 2, color = 'grey')+
  geom_line(aes(x = date, y = count), linewidth = 1.1, color = 'black')+
  geom_point(aes(x = date, y = count), size = 1.2, color = 'black')+
  scale_y_continuous(name = "Skeeter Rafts (#)", limits = ylims)+
  scale_x_continuous(breaks = labelsDf$date, labels = labelsDf$datelab, sec.axis = dup_axis(labels = labelsDf$day))+
...
nbGLMMMedian = nb_glmm_pred %>% filter(date == min(as.Date(current_date)+1,as.Date("2024-07-13"))) %>% select(prediction) %>% unlist

nbGLMMInt = nb_glmm_pred %>% filter(date == min(as.Date(current_date)+1,as.Date("2024-07-13"))) %>% select(lower,upper) %>% unlist
...
nbGLMM_accDf %>%
  ggplot()+
  geom_line(data = nbGLMM_accDf %>% mutate(count = coalesce(count, prediction)), aes(x = date, y = count), linewidth = 1, color = 'grey')+
  geom_errorbar(data = nbGLMM_accDf , aes(x = date, ymin = lower, ymax = upper), linewidth = 1.2, color = 'grey', width = 0)+
  geom_point(data = nbGLMM_accDf, aes(x = date, y = prediction), size = 2, color = 'grey')+
  geom_line(aes(x = date, y = count), linewidth = 1.1, color = 'black')+
  geom_point(aes(x = date, y = count), size = 1.2, color = 'black')+
  scale_y_continuous(name = "Skeeter Rafts (#)", limits = ylims)+
  scale_x_continuous(breaks = labelsDf$date, labels = labelsDf$datelab, sec.axis = dup_axis(labels = labelsDf$day))+
...
poisGAMMMedian = pois_gamm_pred %>% filter(date == min(as.Date(current_date)+1,as.Date("2024-07-13"))) %>% select(prediction) %>% unlist

poisGAMMInt = pois_gamm_pred %>% filter(date == min(as.Date(current_date)+1,as.Date("2024-07-13"))) %>% select(lower,upper) %>% unlist
...
poisGAMM_accDf %>%
  ggplot()+
  geom_line(data = poisGAMM_accDf %>% mutate(count = coalesce(count, prediction)), aes(x = date, y = count), linewidth = 1, color = 'grey')+
  geom_errorbar(data = poisGAMM_accDf , aes(x = date, ymin = lower, ymax = upper), linewidth = 1.2, color = 'grey', width = 0)+
  geom_point(data = poisGAMM_accDf, aes(x = date, y = prediction), size = 2, color = 'grey')+
  geom_line(aes(x = date, y = count), linewidth = 1.1, color = 'black')+
  geom_point(aes(x = date, y = count), size = 1.2, color = 'black')+
  scale_y_continuous(name = "Skeeter Rafts (#)", limits = ylims)+
  scale_x_continuous(breaks = labelsDf$date, labels = labelsDf$datelab, sec.axis = dup_axis(labels = labelsDf$day))+
